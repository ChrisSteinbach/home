...
au Filetype lua setl et ts=4 sw=4
set laststatus=2
let g:lightline = {
      \ 'colorscheme': 'wombat',
      \ 'mode_map': { 'c': 'NORMAL' },
...
omap im gn
omap iM gN
omap m :call MoveMatchEnd()<CR>
omap M :call MoveMatchStart()<CR>

cnoremap <expr> %% getcmdtype() == ':' ?  expand('%:h').'/' : '%%'
hi ColorColumn ctermbg=LightYellow guibg=#ffffaf
